...
class CompraEstado
{
    ...
    public function insertar()
    {
        $resp = false;
        $base = new BaseDatos();
        $sql = "INSERT INTO compraestado (idcompra, idcompraestadotipo, cefechaini, cefechafin)  VALUES('" . $this->getIdCompra() . "','" . $this->getIdCompraEstadoTipo() .
            "','" . $this->getCeFechaIni() . "'," . ($this->getCeFechaFin() != null ? "'" . $this->getCeFechaFin() . "'" : "null") . ")";
