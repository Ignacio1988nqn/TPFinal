...
class Producto
{
    ...
    public function modificar()
    {
        $resp = false;
        $base = new BaseDatos();
        $sql = "UPDATE producto SET pronombre='" . $this->getProNombre() . "', prodetalle = '" . $this->getProDetalle() . "', procantstock = '" . $this->getProCantStock() . "', tipo = '" . $this->getTipo() . "' WHERE idproducto = '" . $this->getIdProducto() . "' ";
        if ($base->Iniciar()) {
    ...
    public static function getLastInsertId()
    {
        $resp = false;
        $base = new BaseDatos();
        $sql = "select max(idproducto) idproducto FROM producto";
        if ($base->Iniciar()) {
            $res = $base->Ejecutar($sql);
            $row = $base->Registro();
